    ...
    <article className={style.gallery}>
      <div className={style.images}>
        <div className={style.image}>
          <img
            alt='/Pancake is a paradise of taste/ it is a temporal image-link, please set the updated link'
        ...
        <div className={style.image}>
          <img
            alt='/Chocolate shake/ it is a temporal image-link, please set the updated link'
        ...
        <div className={style.image}>
          <img
            alt='/Ice creams/ it is a temporal image-link, please set the updated link'
        ...
        <div className={style.image}>
          <img
            alt='/Pancake - Angry Bull/ it is a temporal image-link, please set the updated link'
